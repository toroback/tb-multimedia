...
### Parámetros
  ...
  * Parámetros de la solicitud:
    ...
    | Clave | Tipo | Opcional   | Descripción |
      ...
      |image.crop|String||Tipo de crop que aplicar a la imagen (valores: squared, rounded).|
      |image.rotate|Number||Rotación a aplicar a la imagen en grados. (Ej. 90, 270, 180).|
      |image.resize|Array||Array con los tamaños de la imagen a generar. (valores: t, s, m, l, xl)|
